...
budgetPerDay:
  ...
  midRange: 250
  luxury: 550
gettingThere: 'From Lihue Airport, drive west on Highway 50 to Waimea town, then north on Highway 550 (Waimea Canyon Drive) — about 1.5 hours to the main lookout. Alternatively, take Kokee Road (Highway 552) from Kekaha for a different scenic route.'
essentials:
  - { icon: '🌐', label: 'Language', value: 'English, Hawaiian' }
  - { icon: '💵', label: 'Currency', value: 'USD' }
  - { icon: '🥾', label: 'Hiking', value: 'Multiple trails from easy to strenuous' }
  - { icon: '🌧️', label: 'Weather', value: 'Clouds build by afternoon — go early' }
  - { icon: '🚗', label: 'Transport', value: 'Rental car required' }
  - { icon: '📍', label: 'Elevation', value: 'Lookouts at 3,400–4,200 feet' }
highlights:
  - 'Waimea Canyon Lookout — panoramic views of the 3,600-foot gorge'
  - 'Kalalau Lookout over the Na Pali Coast from above'
  - 'Pu u O Kila Lookout into remote Kalalau Valley'
  - 'Cliff Trail and Canyon Trail hiking with waterfall views'
  - 'Koke e State Park with native Hawaiian forests'
  - 'Red, orange, and green layered canyon walls stretching 14 miles'
  - 'Native Hawaiian bird species including the i iwi and apapane'
gradientColors: 'from-red-400 via-amber-500 to-green-600'
relatedDestinations: ['na-pali-coast', 'poipu', 'honolulu']
faqItems:
  - question: 'Why is Waimea Canyon called the Grand Canyon of the Pacific?'
    answer: 'Mark Twain reportedly gave it the nickname (though this is debated). The canyon is 14 miles long, 1 mile wide, and over 3,600 feet deep, with dramatically layered red, orange, and green walls. While smaller than Arizona Grand Canyon, its lush tropical vegetation and waterfalls give it a unique beauty.'
  - question: 'What is the best time of day to visit Waimea Canyon?'
    answer: 'Morning. Clouds typically build by early afternoon and can completely obscure the canyon and lookout views. Arrive by 9–10am for the clearest skies. Morning light also produces the best colors on the canyon walls.'
  - question: 'How long should I spend at Waimea Canyon?'
    answer: 'A half-day covers the main lookouts and a short hike. A full day lets you explore Koke e State Park, hike the Canyon Trail to Waipo o Falls, and visit the Kalalau Lookout. Combine with a stop in historic Waimea town.'
  - question: 'What are the best hikes in the area?'
