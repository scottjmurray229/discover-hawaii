...
budgetPerDay:
  ...
  midRange: 350
  luxury: 900
gettingThere: 'Fly into Daniel K. Inouye International Airport (HNL), just 20 minutes from Waikiki by car, shuttle, or TheBus Route 19/20. Most hotels offer airport shuttle service.'
essentials:
  - { icon: '🌐', label: 'Language', value: 'English, Hawaiian' }
  - { icon: '💵', label: 'Currency', value: 'USD' }
  - { icon: '☀️', label: 'Best Season', value: 'Apr–Jun & Sep–Oct' }
  - { icon: '🚌', label: 'Transport', value: 'TheBus, trolley, rideshare' }
  - { icon: '🕐', label: 'Time Zone', value: 'HST (UTC-10)' }
  - { icon: '🔌', label: 'Power', value: 'Type A/B, 120V' }
highlights:
  - 'Surf lessons on gentle Waikiki waves — perfect for beginners'
  - 'Sunset catamaran cruises along the coastline'
  - 'Duke Kahanamoku statue and the birthplace of modern surfing'
  - 'World-class shopping along Kalakaua Avenue'
  - 'Friday night fireworks at Hilton Hawaiian Village'
  - 'Outrigger canoe rides with local watermen'
  - 'Fresh poke bowls at beachside restaurants'
gradientColors: 'from-cyan-400 via-blue-500 to-indigo-600'
relatedDestinations: ['diamond-head', 'honolulu', 'kailua']
faqItems:
  - question: 'Is Waikiki good for beginner surfers?'
    answer: 'Absolutely. Waikiki has some of the most gentle, rolling waves in Hawaii, making it the ideal spot to learn. Dozens of surf schools operate right on the beach with lessons starting around $80–$120.'
  - question: 'When is the best time to visit Waikiki?'
    answer: 'April through June and September through October offer the best weather with fewer crowds and lower hotel rates. Summer is warm and dry while winter brings bigger surf on the North Shore but Waikiki stays calm.'
  - question: 'How expensive is Waikiki compared to other Hawaiian destinations?'
    answer: 'Waikiki is one of the pricier areas due to its popularity, but budget options exist. Hostels start around $40/night, mid-range hotels run $200–$350/night, and luxury resorts start at $500+/night.'
  - question: 'Can I get around Waikiki without a car?'
    answer: 'Yes. Waikiki is very walkable, and TheBus system connects you to the rest of Oahu for just $3 per ride. Trolleys, rideshares, and bike rentals are also readily available.'
  - question: 'What are the best day trips from Waikiki?'
    answer: 'Diamond Head (20 minutes by car or TheBus) for the iconic crater hike. Kailua Beach (30 minutes via Pali Highway) for the most beautiful beach on Oahu. Pearl Harbor (30 minutes west) for WWII history. The North Shore (45 minutes north) for legendary surf and shrimp trucks. All are excellent half-day or full-day excursions from a Waikiki base.'
  - question: 'What is the difference between Waikiki Beach and other Oahu beaches?'
    answer: 'Waikiki is sheltered, calm, and well-serviced with surf instructors, catamaran rides, and restaurants within steps. Other Oahu beaches like Kailua or the North Shore are wilder, less crowded, and often more beautiful — but lack the infrastructure and activities that make Waikiki so accessible for first-timers.'
  - question: 'Is there good snorkeling in Waikiki?'
    answer: 'Waikiki Beach itself has limited marine life due to high foot traffic. The best nearby snorkeling is at Hanauma Bay (45-minute drive, requires advance reservation), which has incredible reef fish and sea turtles. Closer options include Sans Souci Beach (east end of Waikiki) and the rock formations off Diamond Head. Boat trips to snorkeling spots are also widely available from Waikiki Harbor.'
  - question: 'When do the Friday night fireworks happen at Waikiki?'
    answer: 'The Friday Night Fireworks at Hilton Hawaiian Village happen every Friday evening at approximately 7:45pm (timing varies seasonally). Free to watch from the beach. The best viewing spots are the Hilton beach area, the adjacent Duke Kahanamoku Beach, and any catamaran or boat offshore. They last about 5 minutes but are a beloved Waikiki tradition.'
affiliatePicks:
  - name: 'Outrigger Waikiki Beach Resort'
    type: 'hotel'
    price: '$$$'
    personalNote: 'Right on the sand with ocean-view rooms and an unbeatable location at the heart of Waikiki.'
    affiliateUrl: 'https://www.booking.com/hotel/us/outrigger-waikiki-beach-resort.html?aid=2778866'
    badge: 'Top Pick'
  - name: 'Hans Hedemann Surf School'
    type: 'activity'
    price: '$$'
    personalNote: 'The best surf school in Waikiki — small group lessons with experienced instructors who know these breaks inside out.'
    affiliateUrl: 'https://www.getyourguide.com/waikiki-l1649/surf-lessons-tc185/?partner_id=IVN6IQ3'
