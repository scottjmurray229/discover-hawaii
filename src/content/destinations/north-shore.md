...
budgetPerDay:
  ...
  midRange: 280
  luxury: 650
gettingThere: 'From Honolulu, drive north on H-2 then Kamehameha Highway — about 45 minutes without traffic. TheBus Route 52 runs from Honolulu to Haleiwa. No direct airport shuttles; rent a car for flexibility.'
essentials:
  - { icon: '🌐', label: 'Language', value: 'English, Hawaiian' }
  - { icon: '💵', label: 'Currency', value: 'USD' }
  - { icon: '☀️', label: 'Best Season', value: 'Apr–Sep (calm surf)' }
  - { icon: '🚗', label: 'Transport', value: 'Rental car recommended' }
  - { icon: '🏄', label: 'Surf Season', value: 'Nov–Feb (big waves)' }
  - { icon: '🐢', label: 'Wildlife', value: 'Green sea turtles year-round' }
highlights:
  - 'Watch world-class winter surf at Pipeline and Sunset Beach'
  - 'Snorkel with green sea turtles at Laniakea Beach'
  - 'Shave ice showdown — Matsumoto vs. Aoki in Haleiwa'
  - 'Hike to Kaena Point for albatross and monk seal sightings'
  - 'Farm tours and tropical fruit tastings at local farms'
  - 'Shark cage diving off the North Shore coast'
  - 'Browse art galleries and surf shops in Haleiwa town'
  - 'Jump from the famous Waimea Bay rock'
gradientColors: 'from-teal-400 via-emerald-500 to-cyan-600'
relatedDestinations: ['waikiki', 'kailua', 'honolulu']
faqItems:
  - question: 'When is the best time to watch big wave surfing on the North Shore?'
    answer: 'The big wave season runs from November through February, with the Vans Triple Crown of Surfing typically held in November and December. Waves can reach 30–50 feet during peak swells.'
  - question: 'Is it safe to swim at North Shore beaches?'
    answer: 'In summer (April–September), many North Shore beaches are calm and perfect for swimming and snorkeling. In winter, the massive surf makes most beaches dangerous for swimming. Always check lifeguard flags and conditions.'
  - question: 'How long should I spend on the North Shore?'
    answer: 'A full day trip from Waikiki works well, but staying 2–3 nights lets you soak in the laid-back lifestyle, catch sunrise surf sessions, and explore Haleiwa town without rushing.'
  - question: 'Where can I see sea turtles?'
    answer: 'Laniakea Beach (Turtle Beach) is the most reliable spot. Turtles haul out on the sand daily. Keep a respectful 10-foot distance as required by law.'
  - question: 'Is there good food on the North Shore?'
    answer: 'Absolutely. The North Shore has some of Oahu best eats — from Giovanni shrimp truck to Haleiwa Joe seafood. The food truck scene along Kamehameha Highway is legendary.'
  - question: 'What is the Triple Crown of Surfing?'
    answer: "The Vans Triple Crown of Surfing is a series of three professional surf competitions held on the North Shore from November to December: the Hawaiian Pro at Haleiwa, the Vans World Cup at Sunset Beach, and the Pipeline Masters at Banzai Pipeline. These events represent the culmination of the WSL Championship Tour and draw the world's best surfers. When swells align with competition windows, Pipeline can produce 20–40-foot face waves and draws massive beach crowds. The competitions are free to watch from the sand."
  - question: 'Is the Kaena Point hike worth doing?'
    answer: "Kaena Point is a 5-mile round-trip hike along a rugged coastline trail to the westernmost tip of Oahu — the only major point not reachable by road. The point is a seabird nesting area with a Hawaiian monk seal haul-out zone. Laysan and black-footed albatrosses nest here in winter. The hike itself passes dramatic sea cliffs and blowholes with excellent whale watching views (December–April). No shade, no water — bring plenty of both."
  - question: 'Can I combine the North Shore with the east coast (Kailua) in one day?'
    answer: "Yes — the Circle Island route from Honolulu covers both in a full day. Drive north to Haleiwa (45 minutes), follow Kamehameha Highway along the North Shore beaches, then continue around the north tip of the island through Kahuku, and come back south through Kailua via the Pali Highway. Stops for shrimp trucks, turtle beach, and Haleiwa town make this a 10–12 hour day. Start from Honolulu by 7am."
  - question: 'What is the Haleiwa Farmers Market and when does it run?'
    answer: "The North Shore Farmers Market in Haleiwa runs Thursday afternoons from 2–6pm at Haleiwa Beach Park, and on Sunday mornings from 9am–1pm at the Sunset Beach Elementary School parking lot. Both markets feature local tropical fruits, prepared foods, honey, and artisan goods from the North Shore farming community. The Thursday market is the most accessible for visitors based in Honolulu on a day trip."
affiliatePicks:
  - name: 'Turtle Bay Resort'
    type: 'hotel'
    price: '$$$'
    personalNote: 'The only full-service resort on the North Shore. Oceanfront rooms, two golf courses, and miles of empty beach in both directions.'
    affiliateUrl: 'https://www.booking.com/hotel/us/turtle-bay.html?aid=2778866'
    badge: 'Top Pick'
  - name: 'North Shore Shark Cage Adventure'
    type: 'activity'
    price: '$$'
